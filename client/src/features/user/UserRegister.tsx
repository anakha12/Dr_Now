...
import { FaStethoscope } from "react-icons/fa"; // brand icon
          ...
          {step === "form" ? (
            <>
              ...
              <button
                ...
                className={`w-full py-3 font-semibold rounded-xl shadow-lg text-sm transition hover:scale-105 ${
                  isFormValid()
                    ? "bg-teal-600 hover:bg-teal-700 text-white"
                    : "bg-teal-300 cursor-not-allowed text-white/60"
                }`}
              >
                Send OTP
              </button>
