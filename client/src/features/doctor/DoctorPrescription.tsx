...
import { getDoctorBookingDetails, addPrescriptionToBooking, getDoctorProfile } from "../../services/doctorService";
...
const DoctorPrescription = () => {
  ...
  const addMedicineRow = () =>
    setMedicines([...medicines, { name: "", dose: "", frequency: "", duration: "", notes: "" }]);
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4 text-teal-700">Add Prescription</h2>

      <div className="mb-4">
        <label className="block font-semibold">Patient</label>
        <input value={booking.patientName} readOnly className="border p-2 w-full" />
      </div>
      ...
      <div className="mb-4">
        ...
        <input value={new Date().toLocaleDateString()} readOnly className="border p-2 w-full" />
      </div>
